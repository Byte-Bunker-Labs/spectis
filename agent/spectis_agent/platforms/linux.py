"""Linux-specific MCP configuration paths.
...
def get_mcp_configs() -> list[dict]:
    """Return MCP config descriptors for Linux workstations."""
    home = Path.home()
    config_dir = home / ".config"
    vscode_global = config_dir / "Code" / "User" / "globalStorage"
    vscode_ins_global = config_dir / "Code - Insiders" / "User" / "globalStorage"

    return [
        # ── VS Code ──
        {"client_name": "VS Code", "config_path": config_dir / "Code" / "User" / "mcp.json", "root_key": "servers"},
        {"client_name": "VS Code Insiders", "config_path": config_dir / "Code - Insiders" / "User" / "mcp.json", "root_key": "servers"},
        ...
        # ── Windsurf ──
        {"client_name": "Windsurf", "config_path": config_dir / "Windsurf" / "User" / "mcp.json", "root_key": "mcpServers"},

        # ── Claude Desktop ──
        {"client_name": "Claude Desktop", "config_path": config_dir / "Claude" / "claude_desktop_config.json", "root_key": "mcpServers"},
        ...
        # ── Zed ──
        {"client_name": "Zed", "config_path": config_dir / "zed" / "settings.json", "root_key": "context_servers"},

        # ── JetBrains (global — scans all product variants) ──
        {"client_name": "JetBrains", "config_path": config_dir / "JetBrains", "root_key": "mcpServers", "glob": "*/options/mcp.json"},

        # ── Goose (Block) ──
        {"client_name": "Goose", "config_path": config_dir / "goose" / "profiles.yaml", "root_key": "extensions"},
